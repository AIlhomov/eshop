...
--
-- Host: DESKTOP-HOKTFDM.local    Database: eshop
-- ------------------------------------------------------
...
INSERT INTO `category` VALUES (7,'Black'),(8,'Desktop'),(1,'Electronics'),(9,'Keyboard'),(6,'Laptop'),(4,'Monitor'),(3,'Phone'),(10,'Speaker'),(5,'Tablet'),(2,'White');
...
INSERT INTO `customer` VALUES (1,'John Doe','123 Main St, Cityville, CA','123-456-7890','john.doe@example.com'),(2,'Jane Smith','456 Elm St, Townsville, NY','987-654-3210','jane.smith@example.com'),(3,'Alice Johnson','789 Oak St, Villageton, TX','555-123-4567','alice.johnson@example.com');
...
CREATE TABLE `logg` (
  ...
  CONSTRAINT `logg_ibfk_1` FOREIGN KEY (`invoice_id`) REFERENCES `invoice` (`invoice_id`),
  CONSTRAINT `logg_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `product` (`product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `orders` (
  ...
  `date_of_last_update` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp(),
...
INSERT INTO `orders` VALUES (1,1,1,'2024-03-13 15:05:28',NULL,NULL,NULL,NULL,0),(2,2,2,'2024-03-13 15:05:28',NULL,NULL,NULL,NULL,0);
...
CREATE TABLE `picklist` (
  ...
  CONSTRAINT `picklist_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `orders` (`order_id`),
  CONSTRAINT `picklist_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `product` (`product_id`),
  CONSTRAINT `picklist_ibfk_3` FOREIGN KEY (`shelf_ID`) REFERENCES `stockshelf` (`shelf_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `picklist` VALUES (1,1,1,3,1),(2,2,5,5,1),(3,2,6,8,1),(4,NULL,NULL,NULL,NULL);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`dbadm`@`%`*/ /*!50003 TRIGGER logg_trigger AFTER INSERT ON product FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`dbadm`@`%`*/ /*!50003 TRIGGER logg_trigger_update AFTER UPDATE ON product FOR EACH ROW
BEGIN
...
CREATE TABLE `productcategory` (
  ...
  KEY `product_id` (`product_id`),
  CONSTRAINT `productcategory_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `category` (`category_id`),
  CONSTRAINT `productcategory_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `product` (`product_id`)
...
INSERT INTO `productcategory` VALUES (1,1,1),(2,3,1),(3,7,1),(4,1,2),(5,3,2),(6,7,2),(7,5,3),(8,2,4),(9,10,4),(10,10,5),(11,10,6),(12,5,7),(13,2,7),(14,9,8),(15,6,9),(16,8,10);
...
CREATE TABLE `stock` (
  ...
  KEY `shelf_ID` (`shelf_ID`),
  CONSTRAINT `stock_ibfk_1` FOREIGN KEY (`shelf_ID`) REFERENCES `stockshelf` (`shelf_ID`)
...
--
-- Table structure for table `stockshelf`
--
...
CREATE TABLE `stockshelf` (
  ...
  KEY `product_id` (`product_id`),
  CONSTRAINT `stockshelf_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `product` (`product_id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `stockshelf`
--

LOCK TABLES `stockshelf` WRITE;
/*!40000 ALTER TABLE `stockshelf` DISABLE KEYS */;
INSERT INTO `stockshelf` VALUES (1,1,'A:101','Gaming',100),(2,2,'B:101','Office',6),(3,4,'C:101','Everyday',50),(4,7,'D:101','Office',2),(5,9,'F:101','Music',30),(6,10,'A:102','Party',12),(7,3,'B:102','Phone',42),(8,5,'C:102','Music',70),(9,6,'D:102','Music',5),(10,8,'E:102','Gaming',10);
/*!40000 ALTER TABLE `stockshelf` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_status` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`dbadm`@`%` FUNCTION `get_status`(a_created TIMESTAMP,
    a_updated TIMESTAMP,
...
BEGIN
    ...
    IF a_updated > a_created THEN
        SET status = 'Updated';
    ELSEIF a_deleted IS NOT NULL THEN
        SET status = 'Deleted';
    ELSEIF a_activated IS NOT NULL THEN
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`dbadm`@`%` PROCEDURE `confirm_order`(
    c_id INT
)
BEGIN
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `get_available_product` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`dbadm`@`%` PROCEDURE `get_available_product`()
BEGIN
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`dbadm`@`%` PROCEDURE `get_customer`()
BEGIN
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `get_inv` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`dbadm`@`%` PROCEDURE `get_inv`()
BEGIN
    SELECT 
        p.product_id,
        p.name,
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`dbadm`@`%` PROCEDURE `get_inventory`(
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`dbadm`@`%` PROCEDURE `get_log`(
    limits INT
    )
BEGIN
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `get_next_product_id` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`dbadm`@`%` PROCEDURE `get_next_product_id`()
BEGIN
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`dbadm`@`%` PROCEDURE `get_order`()
BEGIN
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `get_order_by_str` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`dbadm`@`%` PROCEDURE `get_order_by_str`(
    str_filter VARCHAR(100)
)
BEGIN
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`dbadm`@`%` PROCEDURE `get_picklist`(
    o_id INT
)
BEGIN
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `get_product_order` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`dbadm`@`%` PROCEDURE `get_product_order`(
    o_id INT
)
BEGIN
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`dbadm`@`%` PROCEDURE `get_shelf`()
BEGIN
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`dbadm`@`%` PROCEDURE `insert_inventory`(
    p_id INT,
    s_shelf_row INT, 
    s_amount INT
)
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`dbadm`@`%` PROCEDURE `insert_order_details`(
    o_id INT,
    o_q INT
)
BEGIN
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `insert_order_row` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`dbadm`@`%` PROCEDURE `insert_order_row`(
    o_id INT,
    p_id INT,
    o_q INT
)
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `print_log` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`dbadm`@`%` PROCEDURE `print_log`()
BEGIN
    SELECT * FROM logg;
END ;;
DELIMITER ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`dbadm`@`%` PROCEDURE `update_order`(
    o_id INT
)
BEGIN
    UPDATE orders
...
-- Dump completed on 2024-03-13 16:05:43
